...
#' @description Returns all valid transactions on a specific ledger. Converts the JSON response to a list.
...
#' @export
#' @note https://www.stellar.org/developers/horizon/reference/endpoints/transactions-for-ledger.html
#' @examples
#' \donttest{getTransactions_Ledger("300000")}

getTransactions_Ledger <- function(ledger, cursor = NULL, limit = 10, order = "asc", data.table = TRUE, domain = "public"){
