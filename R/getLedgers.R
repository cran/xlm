#' Returns all ledgers.
#' @description Return all valid ledgers in pages or stream them to R.
...
#' @return list
#' @export
#' @note https://www.stellar.org/developers/horizon/reference/endpoints/ledgers-all.html
#' @examples
#' \dontrun{getLedgers(limit = 50)}

getLedgers <- function(limit, cursor = NULL, order = "asc", data.table = TRUE, domain = "public"){
  request = .requestBuilder("ledgers", domain = domain)
